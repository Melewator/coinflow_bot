...
4. Дата (date) должна быть в формате YYYY-MM-DD.
5. Категория должна строго совпадать с одной из предложенного списка.
6. Комментарий (comment) - краткое описание покупки на основе текста.`;
